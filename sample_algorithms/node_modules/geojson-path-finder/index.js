...
PathFinder.prototype = {
    ...
    _addVertex(point, edgeIndex, weightFn) {
        ...
        var w1 = weightFn(this._topo.vertices[k1], point, props);
        var w2 = weightFn(point, this._topo.vertices[k2], props);

        var v12 = this._vertices[k1][k2];
        var v21 = this._vertices[k2][k1];
    ...
    _removeVertex(edgeIndex, v12, v21) {
        var edge1 = this._topo.edges[edgeIndex];
        var edge2 = this._topo.edges[edgeIndex+1];
        var k1 = edge1[0];
        var k2 = edge2[1];
        var k = edge1[1];
        var props = edge1[2];

        delete this._vertices[k1][k];
        delete this._vertices[k][k1];
        delete this._vertices[k][k2];
        delete this._vertices[k2][k];

        this._vertices[k1][k2] = v12;
        this._vertices[k2][k1] = v21;

        delete this._topo.vertices[k];
        this._topo.edges.splice(edgeIndex, 2, [k1, k2, props]);

        return [this._topo.vertices[k1], this._topo.vertices[k2]];
    },
